...
const initFluidCursor = () => {
  ...
  // Listen to document body for mouse movement to ensure we catch all movement
  ...
  function generateColor() {
    ...
    // Make colors very vibrant and visible
    c.r *= 1.2;
    c.g *= 1.2;
    c.b *= 1.2;
    return c;
  ...
  try {
    ...
    // Add initial splash effect to test the system
    setTimeout(() => {
    ...
    console.error('Failed to start fluid animation loop:', error);
  }
};
