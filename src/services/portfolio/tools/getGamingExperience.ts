...
export const getGamingExperience = tool({
  description:
    'This tool showcases 5+ years of data engineering/analytics engineer experience across enterprise clients and industries, highlighting pipeline impact and technical achievements',
  parameters: z.object({}),
  execute: async () => {
    return {
      experience: [
